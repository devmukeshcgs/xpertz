                ...
                f = {
                    ...
                    _filesCheck: function() {
                        ...
                        for (var t = 0; t < f.files.length; t++) {
                            ...
                            if ((n.uploadFile || n.addMore) && !n.allowDuplicates) {
                                var m = f._itFl.filter(function(a, b) {
                                    if (a.file.name == file.name && a.file.size == file.size && a.file.type == file.type && (file.lastModified ? a.file.lastModified == file.lastModified : true)) {
                                        n.dialogs.alert(f._assets.textParse(n.captions.errors.Duplicate));
										return true;
                                    }
							...
							// if(/^[a-zA-Z0-9.-_ ]*$/.test(strfilename) == false) {
							// 		n.dialogs.alert(f._assets.textParse(n.captions.errors.illegalchar));
							// 		n.dialogs.alert(f._assets.textParse(n.captions.errors.specialchar));
							// 		return false;
							// }
    ...
    $.fn.filer.defaults = {
        ...
        captions: {
            ...
            errors: {
                ...
                filesSize: "The files selected exceed the maximum size permited (1.9Mb > 1.0Mb)",
                filesSizeAll: "The files selected exceed the maximum size permited (1.9Mb > 1.0Mb)",
                folderUpload: "You are not allowed to upload folders.",
				Duplicate: "The file has already been selected",
				specialchar:"Special characters are not allowed in the file name",
				illegalchar:"Your search string contains illegal characters"
            }
        }
    }
